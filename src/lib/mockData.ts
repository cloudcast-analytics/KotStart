...
export const STUDENTS: Student[] = [
  { id: 's1', firstName: 'Emma', lastName: 'Janssen', email: 'emma.janssen@student.ugent.be', phone: '0470 11 22 33', dateOfBirth: '2005-03-14', institution: 'Universiteit Gent (UGent) — Faculteit Ingenieurswetenschappen', studentNumber: '202401234', primaryResidence: 'Kerkstraat 22, 9200 Dendermonde', createdAt: '2025-08-15' },
  { id: 's2', firstName: 'Liam', lastName: 'Pieters', email: 'liam.pieters@student.ugent.be', phone: '0471 44 55 66', dateOfBirth: '2004-07-22', institution: 'Universiteit Gent (UGent) — Faculteit Economie', studentNumber: '202401235', primaryResidence: 'Molenstraat 5, 9000 Gent', createdAt: '2025-08-16' },
  { id: 's3', firstName: 'Sara', lastName: 'Bogaert', email: 'sara.bogaert@student.ugent.be', phone: '0472 77 88 99', dateOfBirth: '2005-11-03', institution: 'Hogeschool Gent (HoGent) — Faculteit Gezondheid', studentNumber: '202401236', primaryResidence: 'Gentstraat 88, 9800 Deinze', createdAt: '2025-08-17' },
  { id: 's4', firstName: 'Noah', lastName: 'De Smedt', email: 'noah.desmedt@student.ugent.be', phone: '0473 00 11 22', dateOfBirth: '2004-05-18', institution: 'Universiteit Gent (UGent) — Faculteit Recht', studentNumber: '202401237', primaryResidence: 'Stationslaan 12, 9300 Aalst', createdAt: '2025-08-18' },
  { id: 's5', firstName: 'Fien', lastName: 'Vandenberghe', email: 'fien.vandenberghe@student.ugent.be', phone: '0474 33 44 55', dateOfBirth: '2005-09-27', institution: 'Universiteit Gent (UGent) — Faculteit Wetenschappen', studentNumber: '202401238', primaryResidence: 'Dorpsstraat 3, 9830 Sint-Martens-Latem', createdAt: '2025-08-19' },
  { id: 's-demo-student', firstName: 'Vincent', lastName: 'Grobben', email: 'vincent.grobben@example.com', phone: '0470 00 00 00', dateOfBirth: '2005-01-01', institution: 'Demo Hogeschool', studentNumber: 'DEMO-001', primaryResidence: 'Teststraat 1, 9000 Gent', createdAt: '2025-08-23' },
]
